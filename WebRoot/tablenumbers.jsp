...
<body>
	...
	<div class="row">
			...
			<div class="panel-group table-responsive" role="tablist">
				...
				<div class="panel panel-primary leftMenu">
					...
					<div id="collapseListGroup2" class="panel-collapse collapse"
						...
						<ul class="list-group">
							<li class="list-group-item">
								<button class="menu-item-left" id = "ding">
		...
		<div class="col-md-10">
			<div><a href = "tabledetails.jsp" class="btn btn-info">1号桌</a></div><br/>
			<div><a href = "tabledetails.jsp" class="btn btn-info">2号桌</a></div><br/>
			<div><a href = "tabledetails.jsp" class="btn btn-info">3号桌</a></div><br/>
			<div><a href = "tabledetails.jsp" class="btn btn-info">4号桌</a></div><br/>
			<div><a href = "tabledetails.jsp" class="btn btn-info">5号桌</a></div>
		</div>
	</div>
